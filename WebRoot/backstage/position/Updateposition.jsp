	...
	<script type="text/javascript" src="<%=path %>/extjs/adapter/ext/ext-base.js"></script>
     <script type="text/javascript" src="<%=path %>/extjs/ext-all.js"></script>
       ...
       fieldLabel: '请选择部门',
           ...
           value:'${position.department.departmentname}',
           valueField :"id",   
       ...
       parent.Ext.getCmp('updatebutton').setHandler(function(){
          if(positionform.form.isValid()){
                  ...
                  url:'<%=path %>/position.do?methede=updatePositionEXT',
                  method:'post',//提交方法post或get
                  waitTitle: "请稍候", 
                  waitMsg: '正在修改职位...', 
                  params:{oid:'${position.id}'},
                  //提交成功的回调函数
                   success:function(f,a){
			       Ext.Msg.alert('ok','修改职位成功');
