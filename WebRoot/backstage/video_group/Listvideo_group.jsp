...
<script type="text/javascript">
  ...
  var addnew=function(){
    ...
    html: '<iframe frameborder="0" width="100%" height="100%" src="<%=path %>/backstage/video_group/Addvideo_group.jsp"></iframe>' 
   });
    add.show(); 
  };  
   ...
   function shownew(id){
      ...
      html: '<iframe frameborder="0" width="100%" height="100%" src="<%=path %>/video_group.do?methede=show&id='+id+'"></iframe>'
      });
      shownew.show();
    };
  ...
  function updatenew(id){ 
    ...
    html: '<iframe frameborder="0" width="100%" height="100%" src="<%=path %>/video_group.do?methede=toUpdate&id='+id+'"></iframe>' 
     });
     update.show();
     }; 
  ...
  if (sm.hasSelection()) {
    ...
    Ext.Ajax.request({
       url: '<%=path %>/video_group.do?methede=batchdeleteEXT',
       method: "post",
       params:{id:id},
  ...
  {header : '类别',dataIndex : 'grouptype',sortable:true,align:'center'}, 
  {header : '可见性',dataIndex : 'visibility',sortable:true,align:'center'}, 
  {header : '用户id',dataIndex : 'userid',sortable:true,align:'center'}, 
