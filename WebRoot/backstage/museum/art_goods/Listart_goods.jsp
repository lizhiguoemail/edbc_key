...
<script type="text/javascript"><!--
  ...
  var addnew=function(){
    ...
    html: '<iframe frameborder="0" width="100%" height="100%" src="<%=path %>/backstage/museum/art_goods/Addart_goods.jsp"></iframe>' 
   });
    add.show(); 
  };  
  ...
  function updatenew(id){ 
    ...
    html: '<iframe frameborder="0" width="100%" height="100%" src="<%=path %>/art_goods.do?methede=toUpdate&id='+id+'"></iframe>' 
     });
     update.show();
     }; 
  ...
  if (sm.hasSelection()) {
    ...
    Ext.Ajax.request({
       url: '<%=path %>/art_goods.do?methede=batchdeleteEXT',
       method: "post",
       params:{id:id},
  ...
  if (sm.hasSelection()) {
    ...
    Ext.Ajax.request({
       url: '<%=path %>/art_goods.do?methede=batchsetEXT',
       method: "post",
  ...
  {header : '展品图片',dataIndex : 'pic',width:150,sortable:true,align:'center', renderer:function(val){return '<img style="width:100px;height:100px;" src="<%=path %>/upload/art_goods/'+val+'">'}}, 
  {header : '展品描述',dataIndex : 'content',width:300,sortable:true,align:'center',renderer:function(val){return '<div align="left">'+val+'</div>'}}, 
  {header : '展品状态',dataIndex : 'isrecommend',sortable:true,align:'center',renderer:function(val){
       var str="";
       if(val=='1')
       {
         str='<font color="red">热荐展品</font>';
       }
       else{
         str='普通展品';
       }
