...
<html>
  ...
  <font size="2"><font color="red">${pname }</font> 子部门名称：</font></td><td><input type="text" id="nodename"  style="width: 240px;">
  </td></tr>
  <tr align="center"><td height="80px;">
  <font size="2"><font color="red">${pname }</font> 子部门简介：</font></td><td><input type="text" id="introduction"  style="width: 240px;">
  </td></tr>
