...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="<%=path %>/extjs/adapter/ext/ext-base.js"></script>
     ...
     var arr=window.showModalDialog(encodeURI("<%=path %>/interactive.do?methede=seltjman&notreceiver="+receiver.value),"new","dialogHeight:800px;dialogWidth:900px;edge:Raised;center:Yes;help:no;resizable:Yes;status:no;"); 
	 if(arr!=null)
	 {
	 if(receiver.value!='')
	 {
	 receiver.value=receiver.value+","+arr[0];
	 }
	 else
	 {
	   receiver.value=arr[0];
	 } 
	 }
