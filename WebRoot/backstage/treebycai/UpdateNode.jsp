...
<html>
  <head>
	...
	<link href="<%=path %>/css3/css.css" rel="stylesheet" type="text/css" />
    <link href="<%=path %>/css3/style.css" rel="stylesheet" type="text/css" />
  ...
  <font size="2"></td><td><input type="text" id="leibiename"  style="width: 240px;" value="${leibiename }"/>
  </td></tr>
