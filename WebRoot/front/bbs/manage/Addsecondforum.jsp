...
<input type="hidden"  name="parentid" value="${firstforum.id }">
  <table width="1052" border=0 align=center cellpadding=2 cellspacing=1 bordercolor="#799ae1" class=tableborder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">添加二级论坛</th>
      </tr>
      <tr bgcolor="#dee5fa">
      ...
      <tr>
        <td align="right" width="30%"><b>所属一级论坛：</b></td><td align="left">${firstforum.forumname }</td>
      </tr>
       <tr>
        <td align="right" style="padding-top: 10px;"><b>论坛级别：</b></td><td align="left" style="padding-top: 10px;">${rank}</td>
      </tr>
       <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <option value="正规论坛">正规论坛  【只允许注册会员发言】</option>
