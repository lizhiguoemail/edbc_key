...
document.forms[0].action='${pageContext.request.contextPath }/museum.do?methede=toExpert';
document.forms[0].submit();
  ...
  <body>
  <form action="${pageContext.request.contextPath }/museum.do?methede=toExpert" method="post">
 ...
 <c:forEach items="${expertslist}" var="experts">
 <tr><td><div style="border-bottom:1px solid #EEEAE1;height: 5px;">&nbsp;</div></td></tr>
  <tr><td height="200px;" width="155px;" style="padding-top: 5px;" valign="top">
  <img width="150px;" height="190px" src="<%=path %>/upload/experts/${experts.pic }" />
  </td>
  <td align="left" valign="top" style="padding-top: 5px;">
  <div style="padding-left: 10px;font-weight: bold;font-family: fantasy;font-size: 14px;color: #5F5E5A;">
   ${experts.name}
   </div>
  ...
  <c:if test="${not empty expertslist}">
  <div align="center">
